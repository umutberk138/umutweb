    ...
    <div className="h-[600px] flex items-center justify-center relative overflow-hidden rounded-3xl bg-zinc-950 border border-apex-border shadow-2xl">
      ...
      >
        ...
        <div className="text-center mb-8">
          <h2 className="text-2xl font-black italic tracking-tighter uppercase mb-1">Darknet Access</h2>
          <p className="text-[10px] text-zinc-500 font-mono font-bold tracking-widest uppercase italic">// Apex OS Restricted Zone</p>
        </div>

        <form onSubmit={handleLogin} className="space-y-4">
          <div className="space-y-2">
            <label className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest ml-1">Identity</label>
            <input 
              type="text" 
              value={user}
          ...
          <div className="space-y-2">
            <label className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest ml-1">Secret Key</label>
            <input 
              type="password" 
              value={pass}
        ...
        {error && (
          ...
          >
            <span className="text-[10px] text-rose-500 font-bold uppercase tracking-widest">Access Denied: Invalid Credentials</span>
          </motion.div>
        )}
        ...
        <div className="mt-8 pt-6 border-t border-zinc-800 flex items-center justify-center gap-2">
          ...
          <span className="text-[9px] text-zinc-600 font-mono font-bold tracking-widest uppercase">Encryption Level: MIL-SPEC</span>
        </div>
      </motion.div>
    </div>
  );
