    ...
    return (
        <div className="space-y-6 font-mono text-xs">
            <div className="flex gap-2 mb-4">
                ...
                >
                    <Lock size={12} className="inline mr-2" /> {t('tools.encrypt')}
                </button>
                <button 
                ...
                >
                    <Unlock size={12} className="inline mr-2" /> {t('tools.decrypt')}
                </button>
            </div>

            <div className="space-y-3">
                <label className="text-[10px] text-zinc-500 uppercase font-black tracking-widest">{t('tools.input_placeholder')}</label>
                <textarea 
            ...
            {output && (
                <div className="space-y-3 pt-4 border-t border-white/5 animate-in fade-in slide-in-from-bottom-2">
                    <label className="text-[10px] text-zinc-500 uppercase font-black tracking-widest">{t('tools.result')}</label>
            ...
            <div className="bg-rose-500/10 border border-rose-500/20 rounded-2xl p-4 flex items-center gap-4 text-rose-500">
                <ShieldAlert size={20} />
                <span className="text-[9px] uppercase font-black leading-tight tracking-widest">{t('tools.warning_base64')}</span>
            </div>
        </div>
    );
};
       ...
       <div className="space-y-8 font-mono">
           <div className="space-y-3">
               <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest">
                   <span className="text-zinc-500">{t('tools.cpu')}</span>
           ...
           <div className="space-y-3">
               <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest">
                   <span className="text-zinc-500">{t('tools.ram')}</span>
           ...
           <div className="grid grid-cols-2 gap-4">
               <div className="bg-zinc-900/50 p-4 rounded-2xl border border-white/5 text-center">
                  <div className="text-[10px] text-zinc-600 mb-1">{t('tools.temp')}</div>
